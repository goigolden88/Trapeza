...
/**
 * Куда ведут ярлыки: значение `go` в адресе → маршрут. «Записать» до Этапа 4
 * ведёт на «Сегодня»; с Этапа 4 — на открытый текущий приём (Р-16).
 * Адрес ярлыка от этого не меняется.
 */
