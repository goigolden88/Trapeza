 ...
 * до конца дня, а назавтра вопросы новые, и блок снова развёрнут.
 */
export function usualFoldId(today: DateStr): string {
  return `today:usual:${today}`
}

/** «3 приёма» — у заголовка, в том числе у свёрнутого (Р-31). */
