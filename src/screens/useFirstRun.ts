...
/**
 * Пуста ли база и что из этого следует на «Сегодня». Взято из «Делу Время»
 * с d86f0aa, у них — из «Дневников»; номера Р-NN в этом файле — их. Пустая
 * база «Трапезы» — и без блюд с категориями (`firstRun.ts`).
