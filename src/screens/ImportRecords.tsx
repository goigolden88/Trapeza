 ...
 */
const WRITE_ORDER: readonly SyncedStore[] = ['categories', 'dishes', 'templates', 'norms', 'intake']
...
/**
 * Импорт записей из других источников (их Р-60): стартовые блюда и история
 * таблицы (Р-03, Р-09).
 *
 * Взято из «Делу Время» с d86f0aa; своё — порядок записи хранилищ и тексты.
 *
...
export function ImportRecords({ onChanged }: { onChanged: () => Promise<void> }) {
  ...
  return (
    <div className="import">
      <p className="muted">
        Блюда, категории и записи еды из таблиц, заметок и других сервисов. Файл готовится по промпту
        ниже — например, с ИИ.
  ...
  return (
    ...
    <Fold id="settings:import:how" title="Как подготовить файл" sub folded>
      <ol>
        ...
        <li>Добавь в конце свои данные: список блюд, таблицу учёта еды или скриншоты.</li>
